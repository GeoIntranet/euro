                ...
                if ($_POST) {
                    ...
                    if (!empty($languages)) {
                        foreach ($languages as $k => $item) {
                            ...
                            $noscript = Genius_Class_Utils::idml($_POST['Categories'], 'noscript_' . $item['abbreviation'], $_POST['Products']['noscript_' . DEFAULT_LANG_ABBR]);
                            $h1 = Genius_Class_Utils::idml($_POST['Categories'], 'h1_' . $item['abbreviation'], $_POST['Categories']['h1_' . DEFAULT_LANG_ABBR]);
                            $h2 = Genius_Class_Utils::idml($_POST['Categories'], 'h2_' . $item['abbreviation'], $_POST['Categories']['h2_' . DEFAULT_LANG_ABBR]);
